  ...
  return (
    ...
    >
      <motion.div
        ...
        variants={lampLightVariants}
        animate="shake"
      >
        {/* Lamp Light Effects */}
        <div
          style={{ backgroundImage: `conic-gradient(var(--conic-position), var(--tw-gradient-stops))` }}
          className="absolute inset-auto right-1/2 h-56 w-[30rem] bg-gradient-conic from-yellow-400 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
...
const Hero = () => {
  ...
  const handleDownload = () => alert("App Link Is Not Yet Available, Join The Waitlist");
  const handleWaitlist = () => (window.location.href = '/waitlist');

  return (
    <section className="relative p-0 pt-7 md:pt-25 md:p-20 min-h-screen w-full overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-950 dark:via-black dark:to-gray-900">
      <div className="relative z-10 container mx-auto px-5 md:px-0 pt-0 pb-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start min-h-[calc(100vh-8rem)]">
          ...
          <motion.div
            ...
            className="space-y-8 text-left order-1 md:mt-0 mt-20 lg:order-1"
          >
            <motion.h1
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.2 }}
              className="text-4xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold leading-tight text-gray-900 dark:text-white"
            >
            ...
            <motion.p
              ...
              className="text-base sm:text-lg text-gray-600 dark:text-gray-300 max-w-2xl"
            >
  ...
  className="flex flex-wrap items-start gap-4 sm:gap-4"
>
  {/* App Store */}
  <motion.button
    ...
    className="group flex-1 sm:flex-auto px-6 py-3 rounded-xl flex items-center gap-3 bg-black dark:bg-white text-white dark:text-black font-semibold shadow-lg hover:shadow-2xl transition-all duration-300 min-w-[150px]"
  >
    {/* SVG + Text */}
  ...
  <motion.button
    ...
    whileTap={{ scale: 0.95 }}
    onClick={handleDownload}
    className="group flex-1 sm:flex-auto px-6 py-3 rounded-xl flex items-center gap-3 border-2 border-gray-800 dark:border-gray-200 text-gray-800 dark:text-gray-200 font-semibold shadow-lg hover:shadow-2xl hover:bg-gray-50 dark:hover:bg-gray-900 transition-all duration-300 min-w-[150px]"
  >
    <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
  ...
  >
    <motion.div
      animate={{ x: isWaitlistHovered ? 0 : -30, opacity: isWaitlistHovered ? 1 : 0 }}
    ...
    <motion.span
      animate={{ x: isWaitlistHovered ? 50 : 0, opacity: isWaitlistHovered ? 0 : 1 }}
      transition={{ duration: 0.3 }}
    >
      Join the Waitlist
    </motion.span>
          ...
          <motion.div
            ...
            className="relative flex justify-center items-center order-2 lg:order-2 mt-10 lg:mt-0 w-full"
          >
            <LampContainer className="bg-transparent">
              <motion.img
                src="/mock.svg"
                alt="Jhinx Pay App Mockup"
                className="w-[100%] sm:w-[380px] block dark:hidden md:w-[420px] mt-10 lg:w-[450px]"
                initial={{ y: 50 }}
              ...
              <motion.img
                src="/mock-dark.svg"
                alt="Jhinx Pay App Mockup Dark"
                className="hidden dark:block w-[100%] hidden dark:block sm:w-[380px] mt-10 md:w-[420px] lg:w-[450px]"
                initial={{ y: 50 }}
                animate={{ y: [0, -10, 0, 10, 0] }}
                transition={{ repeat: Infinity, duration: 3, ease: 'easeInOut' }}
              />
      ...
      <div className="absolute bottom-20 left-10 w-96 h-96 bg-yellow-400/10 dark:bg-yellow-400/5 rounded-full blur-3xl" />
    </section>
  );
};
